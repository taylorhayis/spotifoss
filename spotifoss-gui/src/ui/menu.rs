...
fn mac_app_menu() -> Menu<AppState> {
    ...
    Menu::new(LocalizedString::new("macos-menu-application-menu"))
        ...
        .entry(
            ...
            MenuItem::new(LocalizedString::new("macos-menu-quit").with_placeholder("Quit Spotifoss"))
                .command(cmd::QUIT_APP_WITH_SAVE)
                .hotkey(SysMods::Cmd, "q"),
        )
        .entry(
            MenuItem::new(LocalizedString::new("macos-menu-hide").with_placeholder("Hide Spotifoss"))
...
fn view_menu() -> Menu<AppState> {
    Menu::new(LocalizedString::new("menu-view-menu").with_placeholder("View"))
        ...
        .entry(
            MenuItem::new(
                LocalizedString::new("menu-item-playlists").with_placeholder("Playlists"),
            )
            .command(cmd::NAVIGATE.with(Nav::Playlists))
