...
fn mac_app_menu() -> Menu<AppState> {
    ...
    Menu::new(LocalizedString::new("macos-menu-application-menu"))
        ...
        .entry(
            ...
            MenuItem::new(LocalizedString::new("macos-menu-quit").with_placeholder("Quit Spotix"))
                .command(cmd::QUIT_APP_WITH_SAVE)
                .hotkey(SysMods::Cmd, "q"),
        )
        .entry(
            MenuItem::new(LocalizedString::new("macos-menu-hide").with_placeholder("Hide Spotix"))
